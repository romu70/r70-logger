...
//TODO: logger is not initialized at first time
//TODO: logger init doesn't accept null or empty
...
test("Logger initialization", function (t) {
    ...
    t.throws(logger.init(null), null, "logger init doesn't accept null or empty");
